...
MODEL_RUN=linux_method3_resnet_four_branch_tc_multi_8ts4v_b24_seed1_i40000_rvt2
MODEL_FOLDER="${RVT_ROOT}/runs/${MODEL_RUN}"
MODEL_NAME=model_4.pth
DATA_ROOT=/home/paichichi/data/AGNOSTOS/unseen_tasks/test
OUTPUT_ROOT="${TCC_ROOT}/downstream/rvt2_lite/runs/fourbranch_multi_40k_eval_1x10"
...
for task in "${TASKS[@]}"; do
  for run_id in 1; do
    ...
    log_name="fourbranch_multi_40k_lite_${task}_run${run_id}"
