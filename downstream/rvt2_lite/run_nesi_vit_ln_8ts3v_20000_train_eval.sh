...
STAMP=${STAMP:-nesi_vit_ln_8ts3v_20000_$(date +%Y%m%d_%H%M%S)}
BASE="${TCC_ROOT}/wsl_result/downstream_rvt2_lite_runs"
RUN_ROOT="${BASE}/nesi_vit_ln_8ts3v_20000_${STAMP}"
TRAIN_LOG_DIR="${BASE}/nesi_vit_ln_8ts3v_20000_train_logs_${STAMP}"
EVAL_LOG_DIR="${BASE}/nesi_vit_ln_8ts3v_20000_eval_logs_${STAMP}"
RAW="${BASE}/nesi_vit_ln_8ts3v_20000_${STAMP}.csv"
SUMMARY="${BASE}/nesi_vit_ln_8ts3v_20000_summary_${STAMP}.csv"
OVERALL="${BASE}/nesi_vit_ln_8ts3v_20000_overall_${STAMP}.csv"
LEVELS="${BASE}/nesi_vit_ln_8ts3v_20000_level_summary_${STAMP}.csv"

RUN=nesi_vit_ln_8ts3v_20000
CFG="${TCC_ROOT}/downstream/rvt2_lite/configs/nesi_vit_ln_8ts3v_20000.yaml"
PRETRAIN="${TCC_ROOT}/NESI_result/nesi_vit_ln_8ts3v_lambda05_lr7p5e5_20k/checkpoint_020000.pt"
...
for rep in $(seq 1 "${REPEATS}"); do
  log_name="nesi_vit_ln_8ts3v_20000_${STAMP}_rep${rep}"
